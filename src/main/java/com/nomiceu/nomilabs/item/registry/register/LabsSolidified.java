...
public class LabsSolidified {
    ...
    public static void initSolidified() {
        ...
        SOLIDIFIED_HYDROGEN = createItem(
                new ItemBase(makeLabsName("solidifiedhydrogen"), LabsCreativeTabs.TAB_NOMI_LABS));
        SOLIDIFIED_KRYPTON = createItem(
                new ItemBase(makeLabsName("solidifiedkrypton"), LabsCreativeTabs.TAB_NOMI_LABS));
        SOLIDIFIED_MERCURY = createItem(
                new ItemBase(makeLabsName("solidifiedmercury"), LabsCreativeTabs.TAB_NOMI_LABS));
        SOLIDIFIED_NEON = createItem(new ItemBase(makeLabsName("solidifiedneon"), LabsCreativeTabs.TAB_NOMI_LABS));
        SOLIDIFIED_NITROGEN = createItem(
                new ItemBase(makeLabsName("solidifiednitrogen"), LabsCreativeTabs.TAB_NOMI_LABS));
    ...
    public static void initStabilized() {
        STABILIZED_EINSTEINIUM = createItem(
                new ItemBase(makeLabsName("stabilizedeinsteinium"), LabsCreativeTabs.TAB_NOMI_LABS));
        STABILIZED_BERKELIUM = createItem(
                new ItemBase(makeLabsName("stabilizedberkelium"), LabsCreativeTabs.TAB_NOMI_LABS));
        STABILIZED_NEPTUNIUM = createItem(
                new ItemBase(makeLabsName("stabilizedneptunium"), LabsCreativeTabs.TAB_NOMI_LABS));
        STABILIZED_PLUTONIUM = createItem(
                new ItemBase(makeLabsName("stabilizedplutonium"), LabsCreativeTabs.TAB_NOMI_LABS));
        STABILIZED_URANIUM = createItem(
                new ItemBase(makeLabsName("stabilizeduranium"), LabsCreativeTabs.TAB_NOMI_LABS));
        STABILIZED_CURIUM = createItem(new ItemBase(makeLabsName("stabilizedcurium"), LabsCreativeTabs.TAB_NOMI_LABS));
        STABILIZED_CALIFORNIUM = createItem(
                new ItemBase(makeLabsName("stabilizedcalifornium"), LabsCreativeTabs.TAB_NOMI_LABS));
        STABILIZED_AMERICIUM = createItem(
                new ItemBase(makeLabsName("stabilizedamericium"), LabsCreativeTabs.TAB_NOMI_LABS));
    }
}
