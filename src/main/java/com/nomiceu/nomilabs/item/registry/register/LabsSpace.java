...
public class LabsSpace {
    ...
    public static void initSpace() {
        ...
        UNPREPARED_SPACE_HELMET = createItem(
                new ItemBase(makeLabsName("unpreparedspacehelmet"), LabsCreativeTabs.TAB_NOMI_LABS));
        UNPREPARED_SPACE_CHESTPIECE = createItem(
                new ItemBase(makeLabsName("unpreparedspacechestpiece"), LabsCreativeTabs.TAB_NOMI_LABS));
        UNPREPARED_SPACE_LEGGINGS = createItem(
                new ItemBase(makeLabsName("unpreparedspaceleggings"), LabsCreativeTabs.TAB_NOMI_LABS));
        UNPREPARED_SPACE_BOOTS = createItem(
                new ItemBase(makeLabsName("unpreparedspaceboots"), LabsCreativeTabs.TAB_NOMI_LABS));
    }
}
