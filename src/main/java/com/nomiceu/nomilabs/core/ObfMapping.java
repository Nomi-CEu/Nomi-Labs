...
/**
 * @apiNote codechicken.asm.ObfMapping & gregtech.asm.util.ObfMapping
 */
            ...
            try {
                ...
                if (rawFieldMaps == null) {
                    throw new IllegalStateException(
                            "com.nomiceu.nomilabs.core.ObfMapping loaded too early. Make sure all references are in or after the asm transformer load stage");
                }
