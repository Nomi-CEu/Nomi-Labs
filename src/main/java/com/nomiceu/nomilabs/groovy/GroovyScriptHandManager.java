...
public class GroovyScriptHandManager {
    ...
    public static void addToHand(GsHandEvent event) {
        ...
        event.messages.add(
                TextCopyable.translation(allComponents, "nomilabs.command.gs_hand.all_material_components").build());
    }
    ...
    private static void addToMessage(GsHandEvent event, MaterialStack material, boolean list) {
        ...
        event.messages.add(new TextComponentString(" - ")
                .appendSibling(new TextComponentString(material.material.getLocalizedName())
    ...
    private static String getName(MaterialStack material) {
        return material.material.getModid().equals(GTValues.MODID) ? material.material.toString() :
                material.material.getRegistryName();
    }
}
