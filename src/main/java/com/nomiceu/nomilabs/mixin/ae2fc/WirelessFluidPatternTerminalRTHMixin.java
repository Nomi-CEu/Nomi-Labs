...
import com.glodblock.github.integration.jei.WirelessFluidPatternTerminalRecipeTransferHandler;
 ...
 */
@Mixin(value = WirelessFluidPatternTerminalRecipeTransferHandler.class, remap = false)
public class WirelessFluidPatternTerminalRTHMixin {

    @WrapOperation(method = "transferRecipe(Lcom/glodblock/github/client/container/ContainerWirelessFluidPatternTerminal;Lmezz/jei/api/gui/IRecipeLayout;Lnet/minecraft/entity/player/EntityPlayer;ZZ)Lmezz/jei/api/recipe/transfer/IRecipeTransferError;",
                   at = @At(value = "NEW",
    ...
    private RecipeTransferBuilder setContainer(IRecipeLayout recipe, Operation<RecipeTransferBuilder> original,
                                               @Local(argsOnly = true) ContainerWirelessFluidPatternTerminal container) {
