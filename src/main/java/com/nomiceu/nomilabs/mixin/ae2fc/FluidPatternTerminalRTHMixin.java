...
import com.glodblock.github.integration.jei.FluidPatternTerminalRecipeTransferHandler;
...
public class FluidPatternTerminalRTHMixin {

    @WrapOperation(method = "transferRecipe(Lcom/glodblock/github/client/container/ContainerFluidPatternTerminal;Lmezz/jei/api/gui/IRecipeLayout;Lnet/minecraft/entity/player/EntityPlayer;ZZ)Lmezz/jei/api/recipe/transfer/IRecipeTransferError;",
                   at = @At(value = "NEW",
    ...
    private RecipeTransferBuilder setContainer(IRecipeLayout recipe, Operation<RecipeTransferBuilder> original,
                                               @Local(argsOnly = true) ContainerFluidPatternTerminal container) {
