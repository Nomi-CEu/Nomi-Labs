...
public class SolarFluxMixin {
    ...
    @Redirect(method = "preInit", at = @At(value = "INVOKE", target = "Ltk/zeitheron/solarflux/SolarFlux$FinalFieldHelper;setStaticFinalField(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Object;)Z"), require = 1)
    private boolean setStaticFinalFieldConfig(Class<?> cls, String var, Object val) {
        CONFIG_DIR = (File) val;
        return true;
    }
    
    @Redirect(method = "init", at = @At(value = "INVOKE", target = "Ltk/zeitheron/solarflux/SolarFlux$FinalFieldHelper;setStaticFinalField(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Object;)Z"), require = 1)
