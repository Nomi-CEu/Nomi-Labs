...
public class LabsFluids {
    ...
    public static Fluid BROMINE_CHLORINE_MIXTURE;
    public static Fluid DEPLETED_BRINE;
    public static Fluid TOUGH_ALLOY;
    public static Fluid ALKALINE_BROMINE_SOLUTION;
    public static Fluid DEBROMINATED_WASTE;
    public static Fluid CRUDE_BROMINE;
