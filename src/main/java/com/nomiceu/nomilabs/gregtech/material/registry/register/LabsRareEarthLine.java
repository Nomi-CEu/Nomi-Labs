...
public class LabsRareEarthLine {
    public static void initRareEarthLine() {
        ...
        RareEarthOxideConcentrate = new Material.Builder(118, makeLabsName("rare_earth_oxide_concentrate")) // Hardmode Material
                .dust()
                .color(0x394c04).iconSet(FINE)
                .flags(DISABLE_DECOMPOSITION)
                .build();

        RoastedRareEarthOxideConcentrate = new Material.Builder(119, makeLabsName("roasted_rare_earth_oxide_concentrate")) // Hardmode Material
                .dust()
                .color(0x182100).iconSet(ROUGH)
                .flags(DISABLE_DECOMPOSITION)
                .build();

        LeechedRareEarthOxide = new Material.Builder(120, makeLabsName("leeched_rare_earth_oxide")) // Hardmode Material
                .dust()
        ...
        DissolvedCeriumConcentrate = new Material.Builder(123, makeLabsName("dissolved_cerium_concentrate")) // Hardmode Material
                .liquid()
                .color(0xc1796c)
                .flags(DISABLE_DECOMPOSITION)
                .build();
